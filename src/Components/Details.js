...
class Details extends React.Component {
    ...
    render() {
        const { restaurant, menuItemsModalIsOpen, menuitems, subTotal, formsModalIsOpen, galleryModalIsOpen } = this.state;
        return (
            <div className='container-fluid'>
                ...
                <button classNameName="btn btn-danger" style={{ float: 'right', margin: '15px', backgroundColor: '#ce0505' }} onClick={() => {
